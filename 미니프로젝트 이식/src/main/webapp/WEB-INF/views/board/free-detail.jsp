        ...
        <main>
            ...
            <div class="container mt-3 w-50">
                <form id="modify-form" action="/board/modify.do" method="post">
                    ...
                    <input type="hidden" name="regdate" value="${freeBoard.regdate}">
                    <input type="hidden" name="moddate" value="${freeBoard.moddate}">
                    ...
                    <div class="form-group mt-3">
                        ...
                        value="<javatime:format value="${freeBoard.regdate}" pattern="yyyy-MM-dd"></javatime:format>"
                               readonly required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="moddate">수정일</label>
                        <input type="text" class="form-control" id="moddate"
                               value="<javatime:format value="${freeBoard.moddate}" pattern="yyyy-MM-dd"></javatime:format>" readonly required>
                    </div>
                    <div class="form-group mt-3">
                    ...
                    <c:if test="${loginMember ne null and loginMember.id eq freeBoard.WRITER_ID}">
                        <div class="container mt-3 mb-5 w-50 text-center">
                            ...
                            <button type="button" id="btn-delete" class="btn btn-outline-secondary ml-2" onclick="location.href='/board/deleteBoard.do?id=${freeBoard.id}&type=free'">삭제</button>
                        </div>
                    </c:if>
                </form>
            </div>
